  ...
  const loadAllData = useCallback(async () => {
    ...
    try {
      ...
      if (performance) {
        ...
        // Les données sousAdmins sont déjà initialisées plus haut (ligne 121)
        // Ne pas écraser avec des données sans les nouvelles propriétés (type_service, inactive, etc.)
      }
